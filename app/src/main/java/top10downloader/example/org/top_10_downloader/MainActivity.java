    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnParse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean operationStatus = parse.proces();
                if(operationStatus){
...
//                    ArrayAdapter<Application> adapter = new ArrayAdapter<Application>(MainActivity.this, R.layout.list_item, allApps);
                    LazyAdapter adapter=new LazyAdapter(MainActivity.this, allApps);
                    listApps.setVisibility(listApps.VISIBLE);
                    listApps.setAdapter(adapter);
                }else{
                    Log.d("MAin Activity", "Error parsing xml");
                }
            }
        });
